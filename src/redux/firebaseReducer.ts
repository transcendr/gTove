...
export function updateFirebaseSettingAction(
  settings: FirebaseSettingReducerType
): UpdateFirebaseSettingActionType {
...
const firebaseReducer: Reducer<FirebaseSettingReducerType> = (
  state = initState,
  action: UpdateFirebaseSettingActionType
) => {
  switch (action.type) {
